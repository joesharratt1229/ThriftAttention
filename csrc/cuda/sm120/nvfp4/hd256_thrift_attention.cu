...
static void thrift_attention_nvfp4_typed_hd256(
...
{
    if (is_bf16) {
        thrift_attention_nvfp4_typed_hd256<__nv_bfloat16, true>(
        ...
        thrift_attention_nvfp4_typed_hd256<half, true>(
            Q_fp16_raw, K_fp16_raw, V_fp16_raw, selected_blocks_raw, topk_count,
            topk_mask_raw, topk_word_count, Q_raw, K_raw, V_raw, S_Q_raw, S_K_raw,
            S_V_raw, O_raw, rowmax_state_raw, rowsum_state_raw, bs, q_len,
            kv_len, kv_capacity, num_q_heads, num_kv_heads, head_dim);
...
{
    if (is_bf16) {
        thrift_attention_nvfp4_typed_hd256<__nv_bfloat16, false>(
            Q_fp16_raw, K_fp16_raw, V_fp16_raw, selected_blocks_raw, topk_count,
            topk_mask_raw, topk_word_count, Q_raw, K_raw, V_raw, S_Q_raw, S_K_raw,
            S_V_raw, O_raw, rowmax_state_raw, rowsum_state_raw, bs, q_len,
            kv_len, kv_capacity, num_q_heads, num_kv_heads, head_dim);
    } else {
        thrift_attention_nvfp4_typed_hd256<half, false>(
            Q_fp16_raw, K_fp16_raw, V_fp16_raw, selected_blocks_raw, topk_count,
            topk_mask_raw, topk_word_count, Q_raw, K_raw, V_raw, S_Q_raw, S_K_raw,
            S_V_raw, O_raw, rowmax_state_raw, rowsum_state_raw, bs, q_len,
            kv_len, kv_capacity, num_q_heads, num_kv_heads, head_dim);
